    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input name="title" class="form-control input-xlarge"
                           value="<?php if ($post) echo $post->title; ?>">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <div class="editor-wrapper">
                        <textarea name="markdown" cols="50" rows="10"
                                  id="editor"><?php if ($post) echo $post->markdown; ?></textarea>
                    </div>
            ...
            <button data-toggle="modal" data-target="#imageUploadModal" style="display:none"
                    id="uploadImageButton"></button>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body image-upload-modal-body">
                            <div class="panel-body">
                                <button type="button" id="imageLocalButton" class="btn btn-primary pull-right">Upload
                                </button>
                        ...
                        <div class="modal-footer image-upload-modal-footer">
                            <button id="addToPostButton" type="button" data-dismiss="modal" class="btn btn-primary">Add
                                to Topic
                            </button>
                        </div>
                    </div>
